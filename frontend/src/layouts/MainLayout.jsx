          ...
          >
            ...
            {["iPhone", "iPad", "Mac", "AirPods", "Apple Watch"].map((name, idx) => (
              <div key={idx} className="mb-4">
                ...
                >
                  {name}
                  <span className={`transition-transform ${selectedCategory === idx ? "rotate-180" : ""}`}>
                    ▼
                  </span>
                </button>
      ...
      <footer className="bg-black text-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              <h3 className="font-semibold text-sm mb-4 text-gray-400">Mua Sắm Và Tìm Hiểu</h3>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Cửa Hàng</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">iPhone</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">iPad</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Mac</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Watch</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Airpods</a></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-sm mb-4 text-gray-400">Tài Khoản</h3>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Quản Lý Tài Khoản Của Bạn</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Tài Khoản Apple Store</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">iCloud.com</a></li>
              </ul>
            </div>

            <div>
              <h3 className="font-semibold text-sm mb-4 text-gray-400">Apple Store</h3>
              <ul className="space-y-2.5">
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Ứng Dụng Apple Store</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Apple Trade In</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Tài Chính</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Tình Trạng Đơn Hàng</a></li>
                <li><a href="#" className="text-sm text-white hover:text-gray-400 transition-colors">Hỗ Trợ Mua Hàng</a></li>
              </ul>
            </div>
          </div>
