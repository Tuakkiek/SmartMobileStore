...
// Unified Forms (MỚI)
import UnifiedSpecsForm from "./specs/UnifiedSpecsForm";
import UnifiedVariantsForm from "./variants/UnifiedVariantsForm";

// Spec Forms (Chỉ giữ lại cho AirPods, AppleWatch, Accessories)
import AirPodsSpecsForm from "./specs/AirPodsSpecsForm";
import AppleWatchSpecsForm from "./specs/AppleWatchSpecsForm";
import AccessoriesSpecsForm from "./specs/AccessoriesSpecsForm";

// Variant Forms (Chỉ giữ lại cho AirPods, AppleWatch, Accessories)
import AirPodsVariantsForm from "./variants/AirPodsVariantsForm";
import AppleWatchVariantsForm from "./variants/AppleWatchVariantsForm";
import AccessoriesVariantsForm from "./variants/AccessoriesVariantsForm";

// Constants & Hooks
import { INSTALLMENT_BADGE_OPTIONS } from "@/shared/constants/productConstants";
