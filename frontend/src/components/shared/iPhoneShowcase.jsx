        ...
        <div className="relative">
          ...
          >
            {showcaseItems.map((item) => (
              <div
                key={item.id}
                className="flex-shrink-0 w-[320px] md:w-[360px] bg-black rounded-3xl overflow-hidden relative group cursor-pointer hover:scale-105 transition-transform duration-300 h-[600px]"
              >
