...
const AirPodsVariantsForm = ({ variants, onVariantChange, onOptionChange, onAddVariant, onRemoveVariant, onAddOption, onRemoveOption }) => {
  return (
