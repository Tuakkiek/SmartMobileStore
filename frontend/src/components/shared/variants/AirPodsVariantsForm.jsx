// ============================================
// FILE: src/components/shared/variants/AirPodsVariantsForm.jsx
// ✅ VARIANTS FORM CHO AIRPODS - ĐỒNG BỘ VỚI MULTI-IMAGES
// ============================================
...
const AirPodsVariantsForm = ({ variants, onAddVariant, onRemoveVariant, onVariantChange, onImageChange, onAddImage, onRemoveImage, onOptionChange, onAddOption, onRemoveOption }) => {
  return (
            ...
            {variant.options.map((opt, oIdx) => (
              <div key={oIdx} className="grid grid-cols-1 md:grid-cols-4 gap-2 items-end p-3 border rounded-md">
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="VD: AirPods 4 Chống ồn"
...
export default AirPodsVariantsForm;